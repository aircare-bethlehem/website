...
$guestbookurl = "http://garcia.packetpushers.com/guestbook/guestbook.html";
$guestbookreal = "$ENV{'DOCUMENT_ROOT'}/guestbook/guestbook.html";
$guestlog = "$ENV{'DOCUMENT_ROOT'}/guestbook/guestlog.html";
$cgiurl = "/cgi-bin/guestbook/guestbook.pl";
